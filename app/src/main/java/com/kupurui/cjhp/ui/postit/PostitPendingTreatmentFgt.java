...
public class PostitPendingTreatmentFgt extends BaseFragment implements PtrHandler, LoadMoreHandler, HttpListener {
    ...
    public void requestData() {
        ...
        new Repair().waitcl(u_id, String.valueOf(page), this, 1);
        Log.e("id",u_id);
    }
    ...
    void switchUpData(int what) {
        if (what == 0) {
            new Repair().waitcl(u_id, "0", this, 1);
        } else if (what == 1) {
            new Repair().waitcl(u_id, (page + 1) + "", this, 2);
        }
    }

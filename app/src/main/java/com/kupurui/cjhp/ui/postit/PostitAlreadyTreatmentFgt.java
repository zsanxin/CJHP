...
import com.kupurui.cjhp.adapter.AlreadyPostitAdapter;
...
public class PostitAlreadyTreatmentFgt extends BaseFragment implements PtrHandler, LoadMoreHandler, HttpListener {
    ...
    AlreadyPostitAdapter adapter;
    private List<AlreadyPostit> list = new ArrayList<>();
    ...
    public void initData() {
        ...
        adapter = new AlreadyPostitAdapter(getActivity(), list, R.layout.post_already_treament_listview_item);
        ...
        listview.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                bundle.putString("aa", "r");
                bundle.putString("id", list.get(position).getR_id());
    ...
    public void requestData() {
        ...
        new Repair().ycl(u_id, String.valueOf(page), this, 1);
    }
        ...
        switch (what) {
            case 1: //初次加载数据
                if (!(AppJsonUtil.getResultInfo(result).getShow_data().equals("") || AppJsonUtil.getResultInfo(result).getShow_data() == null)) {
                    page = 0;
                    list.clear();
                    list.addAll(JSON.parseArray(AppJsonUtil.getString(result, "list"), AlreadyPostit.class));
            ...
            case 2://上拉加载更多
                if (AppJsonUtil.getResultInfo(result).getShow_data().equals("") || AppJsonUtil.getResultInfo(result).getShow_data() == null
                    ...
                    try {
                        List<AlreadyPostit> moreData = JSON.parseArray(AppJsonUtil.getString(result, "list"), AlreadyPostit.class);
    ...
    void switchUpData(int what) {
        if (what == 0) {
            new Repair().ycl(u_id, "0", this, 1);
        } else if (what == 1) {
            new Repair().ycl(u_id, (page + 1) + "", this, 2);
        }
    }

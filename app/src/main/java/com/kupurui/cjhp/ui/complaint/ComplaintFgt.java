...
import com.kupurui.cjhp.ui.index.IndexComplaintAty;
...
public class ComplaintFgt extends BaseFragment implements HttpListener,CropHandler{
    ...
    public void initData() {
        ...
        etContent.setHint("输入投诉建议描述，最多可以输入200字。");
    }
    ...
    public void onClick(View view) {
        ...
        switch (view.getId()){
            ...
            case R.id.btn_submit:
                ...
                showLoadingDialog("");
                new Complaint().index(u_id,title,content,phone,files,this,1);
                break;
        }
    }
    ...
    public void onSuccess(String result, Call call, Response response, int what) {
        showToast("提交成功");
        IndexComplaintAty aty = (IndexComplaintAty)getActivity();
        aty.setTabSelection(1);

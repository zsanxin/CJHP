...
public class ComplaintPendingTreatmentFgt extends BaseFragment implements PtrHandler, LoadMoreHandler,HttpListener {
    @Bind(R.id.listview)
    ListView listview;
    ...
    public void requestData() {
        ...
        new Complaint().waitcl(u_id,String.valueOf(page),this,1);
    }
